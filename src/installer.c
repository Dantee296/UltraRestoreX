...
install(char *install){
    for (int i = 0; i < ARRAY_SIZE(appName); i++) {
        ...
        //printf("Application %s Installs With Command %s\n", appName[i], installComm[i]);
    }
    
//    if (strcmp(install, "brew") == 0)
//    {
//        //system("/bin/bash -c \"$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)");
//    }
//    else if (strcmp(install, "mon") == 0)
//    {
//        printf("%s", installComm[0]);
//    }
//    else
//    {
//        printf("invalid parameters passed to install function");
//    }
