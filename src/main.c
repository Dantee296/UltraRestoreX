...
const char *menuItems[] = {"Prerequisites",  //ready
                         ...
                         "Boot iPhone -> macOS,iOS", //ready
                         "Remount - Use After Reboot"}; //debug-ready
...
//                      char *origvar = macos_run_e("cat fstab-bak | grep '/private/var apfs' | grep -o disk0s1s.");
            ...
            case 13:
                ...
                if(1==1){
                    ...
                    printf("You Now Have Two Minutes To Reboot Your iPhone To DFU Mode\n");
                    printf("If after two minutes, the exploit fails,reboot your iPhone with checkra1n, run step 13 from normal\nmode, then a new two minute timer starts to put your iPhone in DFU.");
                    sleep(120);
                    system(connect);
                }
                break;
